#############################################################################
# Makefile for building: bin/CFGParser
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  CFGParser.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile CFGParser.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CFGParser1.0.0
DISTDIR = /home/dubem/cfg_parser/obj/CFGParser1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: CFGParser.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile CFGParser.pro
